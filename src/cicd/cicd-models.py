...
def parse_args():
    ...
    parser.add_argument("DOMINO_HARDWARE_TIER_NAME", type=str, help="Name of the hardware tier.")
    parser.add_argument("DOMINO_ENVIRONMENT_ID", type=str, help="ID of the model  environment id.")
...
def model_start(start_job_url,user_api_key, project_id, model_name, model_desc, model_file, model_func,hardware_tier_name, isAsync=False):
    payload = {
...
def main():
    ...
    if inputs.DOMINO_MODEL_OP == "list":
        ...
        model_start(start_job_url, project_id, inputs.DOMINO_MODEL_NAME,inputs.DOMINO_MODEL_DESC,inputs.DOMINO_MODEL_FILE, inputs.DOMINO_MODEL_FUNC, inputs.DOMINO_MODEL_CE, inputs.DOMINO_HARDWARE_TIER_NAME , inputs.DOMINO_ENVIRONMENT_ID, inputs.DOMINO_USER_API_KEY)
